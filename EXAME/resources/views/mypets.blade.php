	...
	<head>
		...
		<meta charset="UTF-8">
		<!-- Site Title -->
		<title>Animal Shelter : my pets</title>
		...
		<body>
			...
			<section class="cat-list-area section-gap">
				...
				@forelse ($myPets as $MP)
				  <div class="media">
					<div class="media-left">
					  <img src="{{asset('assets')}}/img/{{$MP->image}}" alt="" class="img-fluid">
					</div>
					<div class="media-body">
					  <h3 class="mb-30">&nbsp;{{$MP->name}}</h3>
					  <h4 class="media-heading">&nbsp;{{$MP->description}}</h4>
					  <br><p>I was adopted "{{$MP->created_at}}"</p>
					</div>
				  </div>
				  ...
				  {{-- <div class="media">
					...
					<div class="media-body">
					  <h3 class="mb-30">&nbsp;I am doggy!</h3>					
					  <h4 class="media-heading">&nbsp;I am very sweet!</h4>
